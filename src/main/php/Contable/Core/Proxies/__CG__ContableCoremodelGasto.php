 ...
 */
class Gasto extends \Contable\Core\model\Gasto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Contable\\Core\\model\\Gasto' . "\0" . 'fechaHora', '' . "\0" . 'Contable\\Core\\model\\Gasto' . "\0" . 'fechaVencimiento', '' . "\0" . 'Contable\\Core\\model\\Gasto' . "\0" . 'monto', '' . "\0" . 'Contable\\Core\\model\\Gasto' . "\0" . 'estado', '' . "\0" . 'Contable\\Core\\model\\Gasto' . "\0" . 'observaciones', '' . "\0" . 'Contable\\Core\\model\\Gasto' . "\0" . 'user', '' . "\0" . 'Contable\\Core\\model\\Gasto' . "\0" . 'concepto'];
        }
