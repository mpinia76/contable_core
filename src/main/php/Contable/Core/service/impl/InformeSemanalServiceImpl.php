...
use Contable\Core\service\IInformeSemanalService;
...
class InformeSemanalServiceImpl extends CrudService implements IInformeSemanalService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Contable/Core/service/Contable\Core\service.IInformeSemanalService::getInformeAnualPorMes()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Contable/Core/service/Contable\Core\service.IInformeSemanalService::getInformeAnualPorSemana()
	 */
