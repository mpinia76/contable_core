...
use Contable\Core\criteria\MovimientoGastoCriteria;
...
use Contable\Core\service\IGastoService;
...
class GastoServiceImpl extends CrudService implements IGastoService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Contable/Core/service/Contable\Core\service.IGastoService::pagar()
	 */
	public function pagar(Gasto $gasto, Cuenta $cuenta, User $user, $fechaHora){
		...
		$movimiento->setConcepto( ContableUtils::getConceptoMovimientoGasto() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Contable/Core/service/Contable\Core\service.IGastoService::anular()
	 */
	public function anular(Gasto $gasto, User $user){
		...
		if( $gasto->getEstado() == EstadoGasto::Pagado ){
			...
			$contramovimiento->setConcepto( ContableUtils::getConceptoMovimientoAnulacionGasto() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Contable/Core/service/Contable\Core\service.IGastoService::getGastosPorVencer()
	 */
