...
class ContableUtils {
	...
	public static function sendMailPop($nameTo, $to, $subject, $msg, $attachs) {
		...
		$libsHome= ContableConfig::getInstance()->getLibsPath();
        ...
        if( ContableConfig::TEST_MODE ){
        	//me los envío todos a mi en test
        	$to = ContableConfig::TEST_MAIL_TO;
        }
		...
		$mail->Host = ContableConfig::POP_MAIL_HOST;
		//Set the SMTP port number - likely to be 25, 465 or 587
		$mail->Port = ContableConfig::POP_MAIL_PORT;
		$mail->SMTPSecure = ContableConfig::POP_MAIL_SMTP_SECURE;
		//Whether to use SMTP authentication
		$mail->SMTPAuth = true;
		//Username to use for SMTP authentication
		$mail->Username = ContableConfig::POP_MAIL_USERNAME;
		//Password to use for SMTP authentication
		$mail->Password = ContableConfig::POP_MAIL_PASSWORD;
		
		//Set who the message is to be sent from
		$mail->setFrom(ContableConfig::MAIL_FROM, ContableConfig::MAIL_FROM_NAME);
		//Set an alternative reply-to address
		$mail->addReplyTo(ContableConfig::MAIL_FROM, ContableConfig::MAIL_FROM_NAME);
    ...
    public static function sendMail($nameTo, $to, $subject, $msg, $attachs) {
        ...
        if (ContableConfig::MAIL_ENVIO_POP)
