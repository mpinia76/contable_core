...
namespace contable\Core\Proxies\__CG__\Contable\Core\model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Transferencia extends \Contable\Core\model\Transferencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Contable\\Core\\model\\Transferencia' . "\0" . 'fechaHora', '' . "\0" . 'Contable\\Core\\model\\Transferencia' . "\0" . 'monto', '' . "\0" . 'Contable\\Core\\model\\Transferencia' . "\0" . 'estado', '' . "\0" . 'Contable\\Core\\model\\Transferencia' . "\0" . 'observaciones', '' . "\0" . 'Contable\\Core\\model\\Transferencia' . "\0" . 'origen', '' . "\0" . 'Contable\\Core\\model\\Transferencia' . "\0" . 'destino', '' . "\0" . 'Contable\\Core\\model\\Transferencia' . "\0" . 'user'];
        }
